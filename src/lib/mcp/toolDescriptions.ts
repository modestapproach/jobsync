...
export const MCP_TOOL_DESCRIPTIONS = {
  ...
  list_jobs:
    "List the user's saved roles, newest first: id, title, company, status, applied flag/date, due date, match score, URL. Use this to answer 'what do I have saved / where am I with X' and to find ids for update_job. Filter by status, applied, or contactLedgerId (roles tied to one person in the identity ledger); page with limit/offset.",
  find_job:
